...
function parse$1({ focus, annotations, highlightedLines, lang, }) {
    const normalCode = getCode$1(highlightedLines);
...
// 0 - normalize
function getCode$1(highlightedLines) {
...
function EditorSpring(_a) {
    ...
    return (React.createElement(EditorTween, Object.assign({ t: t, backward: false, prev: prev, next: next, files: files }, props)));
}
...
function getCode(step, language) {
    return Object.assign(Object.assign({}, step), { files: step.files.map(file => {
            var _a;
            const diffLang = (file === null || file === void 0 ? void 0 : file.codeInDiffLangs) &&
                (file === null || file === void 0 ? void 0 : file.codeInDiffLangs.length)
                ? file === null || file === void 0 ? void 0 : file.codeInDiffLangs.find((fileCode) => fileCode.code.lang === language)
                : null;
            const code = (_a = diffLang === null || diffLang === void 0 ? void 0 : diffLang.code) !== null && _a !== void 0 ? _a : file.code;
            return Object.assign(Object.assign({}, file), { code });
        }) });
}
function Code(props) {
    var _a;
    const [language, setLanguage] = React.useState((_a = props.files.find(file => file.name === props.northPanel.active)) === null || _a === void 0 ? void 0 : _a.code.lang);
    const [step, setStep] = React.useState(getCode(props, language));
    React.useEffect(() => {
    ...
    return (React.createElement(LanguageContext.Provider, { value: { language, setLanguage } },
        React.createElement(InnerCode, Object.assign({}, step, { onTabClick: onTabClick }))));
}
// build the CodeConfig from props and props.codeConfig
function mergeCodeConfig(props) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
    const { lineNumbers, showCopyButton, showExpandButton, selectLanguages, minZoom, maxZoom } = props, rest = __rest(props, ["lineNumbers", "showCopyButton", "showExpandButton", "selectLanguages", "minZoom", "maxZoom"]);
    const codeConfig = Object.assign(Object.assign({}, props.codeConfig), { maxZoom: maxZoom == null ? (_a = props.codeConfig) === null || _a === void 0 ? void 0 : _a.maxZoom : maxZoom, minZoom: minZoom == null ? (_b = props.codeConfig) === null || _b === void 0 ? void 0 : _b.minZoom : minZoom, horizontalCenter: (_d = (_c = props.codeConfig) === null || _c === void 0 ? void 0 : _c.horizontalCenter) !== null && _d !== void 0 ? _d : props.horizontalCenter, lineNumbers: lineNumbers == null
            ...
            : showExpandButton, selectLanguages: selectLanguages !== null && selectLanguages !== void 0 ? selectLanguages : (_h = props.codeConfig) === null || _h === void 0 ? void 0 : _h.selectLanguages, rows: props.rows, debug: (_j = props.debug) !== null && _j !== void 0 ? _j : (_k = props.codeConfig) === null || _k === void 0 ? void 0 : _k.debug });
...
function Scrollycoding(props) {
    const codeConfig = Object.assign(Object.assign({}, props.codeConfig), props === null || props === void 0 ? void 0 : props.otherCodeConfig);
    return (React.createElement(Swap, { match: [
            [
                codeConfig.staticMediaQuery,
                React.createElement(StaticScrollycoding, Object.assign({}, props, { codeConfig: codeConfig })),
            ],
            [
                "default",
                React.createElement(DynamicScrollycoding, Object.assign({}, props, { codeConfig: codeConfig })),
            ],
        ] }));
}
...
function DynamicScrollycoding(_a) {
    ...
    const tab = state.step;
    const [language, setLanguage] = React.useState(tab.files[0].code.lang);
