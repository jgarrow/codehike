...
const LanguageContext = React__default["default"].createContext({
    language: "shell",
    setLanguage: (lang) => { },
});
...
function Code(props) {
    ...
    return (React__default["default"].createElement(LanguageContext.Provider, { value: { language, setLanguage } },
        React__default["default"].createElement(InnerCode, Object.assign({}, step, { onTabClick: onTabClick }))));
}
...
function Scrollycoding(props) {
    ...
    return (React__default["default"].createElement(Swap, { match: [
            [
                ...
                React__default["default"].createElement(StaticScrollycoding, Object.assign({}, props, { codeConfig: codeConfig })),
            ],
            [
                "default",
                React__default["default"].createElement(DynamicScrollycoding, Object.assign({}, props, { codeConfig: codeConfig })),
            ],
        ] }));
}
...
function DynamicScrollycoding(_a) {
    ...
    const tab = state.step;
    const [language, setLanguage] = React__default["default"].useState(tab.files[0].code.lang);
    ...
    return (React__default["default"].createElement("section", { className: `ch-scrollycoding ${withPreview ? "ch-scrollycoding-with-preview" : ""} ${className || ""}`, style: style, "data-ch-theme": codeConfig === null || codeConfig === void 0 ? void 0 : codeConfig.themeName },
        ...
        React__default["default"].createElement("div", { className: "ch-scrollycoding-sticker" },
            React__default["default"].createElement(LanguageContext.Provider, { value: { language, setLanguage } },
